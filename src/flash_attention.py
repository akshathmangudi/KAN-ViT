# This code has been adopted from the following repository: https://github.com/kyegomez/FlashAttention20
# All credits with respect to this code goes to kyegomez and the github collaborators of that repository.
